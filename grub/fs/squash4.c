...
{
	COMPRESSION_ZLIB = 1,
	COMPRESSION_LZMA = 2, // lzma1
	COMPRESSION_LZO = 3,
	COMPRESSION_XZ = 4, // lzma2
	COMPRESSION_LZ4 = 5,
	COMPRESSION_ZSTD = 6,
};
...
static grub_err_t
grub_squash_dir(grub_disk_t disk, const char* path,
...
static grub_err_t
grub_squash_mtime(grub_disk_t disk, grub_int64_t* tm)
{
	struct grub_squash_data* data = 0;
