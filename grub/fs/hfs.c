...
static grub_err_t
grub_hfs_dir(grub_disk_t disk, const char* path, grub_fs_dir_hook_t hook,
	void* hook_data)
{
	struct grub_hfs_data* data;
...
static grub_err_t
grub_hfs_label(grub_disk_t disk, char** label)
{
	struct grub_hfs_data* data;
...
static grub_err_t
grub_hfs_mtime(grub_disk_t disk, grub_int64_t* tm)
{
	struct grub_hfs_data* data;
...
static grub_err_t
grub_hfs_uuid(grub_disk_t disk, char** uuid)
{
	struct grub_hfs_data* data;
